...
function HomePageNotLoggedIn() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 via-gray-800 to-gray-700 py-10 overflow-hidden relative">
      ...
      {/* Feature Section */}
      <div className="relative z-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 bg-opacity-80 p-6 sm:p-10 rounded-lg shadow-lg text-center max-w-6xl mx-auto bg-gray-900 mt-20 animate-slideUp">
